...
story=[kicker('Propuesta de pasantía educativa · para revisión institucional'),
       ...
       table(['Dato institucional','A completar antes de iniciar'],[['Localidad',cfg['localidad']],['Institución',cfg['institucion']],['Estudiante',cfg['estudiante']],['Docente y autoridad referente',cfg['docente_autoridad']],['Supervisor técnico',cfg['supervisor']],['Inicio / cierre',f"{cfg['fecha_inicio'] or 'Por acordar'} / {cfg['fecha_fin'] or 'Por acordar'}"]],[175,328]),
       h('Propósito'),
       ...
       table(['Participante','Beneficio concreto','Aporte requerido'],[
           ...
           ['Supervisor técnico','Dispone de una estructura de mentoría y revisión con avances observables.','Preparar el entorno, revisar PR y mantener aprobaciones y procedimientos CAD.'],
       ...
       table(['Bloque','Horas','Trabajo y evidencia'],[
         ['Semana 1','5','Entorno, fuentes, lectura del lote 01 y primer PR de práctica.'],
