...
| Dato institucional | A completar antes de iniciar |
| --- | --- |
| Localidad | Por confirmar con la autoridad |
...
| Entregable | Uso |
| --- | --- |
| Inventario CSV y visor local | Buscar nombres, consultar estados y leer fuentes. |
...
| --- | --- |
| Localidad | Confirmación expresa por el referente. El nombre callejero-yacanto identifica el repositorio; no prueba procedencia. |
| Coordenadas | Documentación del CRS y contraste con controles distribuidos. Un punto ayuda a detectar un error grueso; no certifica por sí solo datum, zona y desplazamientos. |
